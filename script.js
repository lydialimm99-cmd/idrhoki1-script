...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateHeaderBg() {
    ...
    const bgBesar = 'url("https://imgstorage.site/view/berlin/header-idrhoki.png")';
    const bgKecil = 'url("https://imgstorage.site/view/berlin/header-idrhoki1.png")';

    if (height >= 100) {
      header.style.setProperty("background-image", bgBesar, "important");
      header.style.setProperty("background-size", "1920px 138px", "important");
    } else {
      header.style.setProperty("background-image", bgKecil, "important");
      header.style.setProperty("background-size", "1920px 92px", "important");
    }
  ...
  updateHeaderBg();
  setTimeout(updateHeaderBg, 300);
  setTimeout(updateHeaderBg, 1000);
  ...
  function injectStyle() {
    ...
    style.textContent = `
      .server-selector-ui {
        ...
        border-radius: 20px;
        background: linear-gradient(180deg, #0B1F3A, #020812);
      ...
      .server-selector-badge {
        ...
        letter-spacing: 1px;
        text-transform: uppercase;
        background: linear-gradient(180deg, #fff200, #ffb300);
...
function createApkBox() {
  ...
  wrap.innerHTML = `
    <div class="maxwin-box">
      <div class="left-panel">
        ...
        <select id="altLink">
          <option value="hoki.linkresmiidrhoki.xyz">hoki.linkresmiidrhoki.xyz</option>
          <option value="hoki2.linkresmiidrhoki.xyz">hoki2.linkresmiidrhoki.xyz</option>
          <option value="hoki.linkresmiidrhoki.xyz">hoki3.linkresmiidrhoki.xyz</option>
        </select>
  ...
  if (copyMainLinkBtn) {
    copyMainLinkBtn.addEventListener("click", function () {
      const value = "https://vuata.link/idrhoki";
